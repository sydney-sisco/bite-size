...
var app = (function () {
    ...
    /* src/Recipe.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "recipe svelte-7qruu6");
    			add_location(div, file$2, 15, 0, 244);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	validate_slots("Recipe", slots, ['default']);
    ...
    /* src/Featured.svelte generated by Svelte v3.37.0 */
    const file$1 = "src/Featured.svelte";

    function get_each_context(ctx, list, i) {
    	const child_ctx = ctx.slice();
    	child_ctx[2] = list[i].title;
    	child_ctx[3] = list[i].summary;
    	child_ctx[5] = i;
    	return child_ctx;
    }
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(h2, file$1, 37, 6, 755);
    			add_location(p, file$1, 38, 6, 778);
    		},
    		m: function mount(target, anchor) {
    ...
    // (36:2) {#each recipes as { title, summary }
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope*/ 64) {
    				recipe_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:2) {#each recipes as { title, summary }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "featured svelte-1a747p0");
    			add_location(div, file$1, 19, 0, 394);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let recipes = [
    		{ title: "Recipe 1", summary: "yummy time" },
    		{
    			title: "Recipe 2",
    			summary: "This is a recipe. It can contain anything."
    		},
    		{ title: "Recipe 3", summary: "yummy time" }
    	];
    	...
    	$$self.$capture_state = () => ({ name, Recipe, recipes });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, Featured });
